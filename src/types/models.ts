...
/**
 * Check if a credential is already expired.
 */
...
/**
 * Get all credentials (passwords + certificates) from an application.
 */
...
/**
 * Get all unique delegated scopes from a service principal.
 */
...
/**
 * Get all unique app roles from a service principal.
 */
...
/**
 * Check if an application has a verified publisher.
 */
...
/**
 * Check if a service principal has a verified publisher.
 */
...
/**
 * Get all credentials that are expiring within 90 days.
 */
...
/**
 * Get days since last activity for a service principal.
 */
...
/**
 * Get the top 10 riskiest service principals from analysis results.
 */
...
/**
 * Count of unique users who granted consent to a service principal.
 */
...
/**
 * Check if a service principal has any delegated permission grants.
 */
...
/**
 * Check if a service principal has any application permission assignments.
 */
...
/**
 * Check if an entity has owners defined.
 */
...
/**
 * Check if a service principal is owned by the current tenant.
 */
